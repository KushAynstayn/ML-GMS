<div class="w-full">
    ...
    <div class="bg-white p-12 rounded-xl shadow-sm border-2 border-dashed border-gray-200 flex flex-col items-center justify-center text-center">
        ...
        <div class="flex gap-2">
            ...
            <button id="selectBtn" onclick="document.getElementById('fileInput').click()" class="bg-gray-600 text-white px-6 py-2 rounded-lg font-bold hover:bg-gray-700 transition-colors">
                Select File
            </button>
        </div>
    </div>
