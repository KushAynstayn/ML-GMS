...
try {
    ...
    // PRIMARY LEDGER LOGIC: 
    // Show all records for the specific category.
    // Unlike the secondary ledger, this does not filter by "Device Installed".
    ...
    if ($loans) {
        ...
        echo "<tr><td colspan='$colspan' class='px-6 py-12 text-center text-gray-400 text-sm italic'>No records found in Primary Ledger.</td></tr>";
    }
} catch (Exception $e) {
    $colspan = ($type === 'motor') ? 4 : 3;
