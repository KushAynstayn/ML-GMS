...
<aside id="sidebar" class="z-20 w-16 hover:w-64 transition-all duration-300 ease-in-out bg-white border-r border-gray-100 flex flex-col justify-between py-6 relative group shrink-10 shadow-[4px_0_8px_rgba(0,0,0,0.05)]">
    <div>
