            ...
            <div class="border border-gray-300 rounded-sm overflow-hidden text-black">
                <div class="text-[13px]">
                    ...
                    <div class="grid grid-cols-12 border-b border-gray-300">
                        ...
                        <div class="col-span-10 p-2 font-bold" id="modalDispContact">9514791978</div>
                    </div>
                    <div class="grid grid-cols-12 border-b border-gray-300">
                        ...
                        <div class="col-span-3 p-2 font-bold text-right" id="modalDispLoanAmt">224,276.00</div>
                    </div>
                    <div class="grid grid-cols-12 border-b border-gray-300">
                        <div class="col-span-2 bg-gray-50 p-2 font-bold border-r border-gray-300">PN Date :</div>
                        <div class="col-span-4 p-2 border-r border-gray-300" id="modalDispPnDate">February 3, 2024</div>
                        <div class="col-span-3 bg-gray-50 p-2 font-bold border-r border-gray-300">Term :</div>
                        <div class="col-span-3 p-2 text-right font-bold" id="modalDispTerm">10 <span class="text-gray-400 font-normal">months</span></div>
                    </div>
                    <div class="grid grid-cols-12 border-b border-gray-300">
                        <div class="col-span-2 bg-gray-50 p-2 font-bold border-r border-gray-300">PN Maturity :</div>
                        <div class="col-span-4 p-2 border-r border-gray-300" id="modalDispMaturity">December 3, 2024</div>
                        <div class="col-span-3 bg-gray-50 p-2 font-bold border-r border-gray-300">Interest Rate (AOR)</div>
                        <div class="col-span-3 p-2 text-right font-bold" id="modalDispAOR">96 %</div>
                    </div>
                    <div class="grid grid-cols-12 bg-gray-50 items-center border-b border-gray-300">
                        ...
                        <div class="col-span-3 p-2 font-bold text-right text-base text-black" id="modalDispMonthly">33,189.65</div>
                    </div>
                </div>
                    ...
                    <table class="w-full text-[12px] border-collapse text-black" id="amortizationTable">
                        <thead>
                            <tr class="border-b border-gray-300 bg-gray-100">
                                <th colspan="7" class="p-2 text-center font-bold uppercase tracking-wider">Application</th>
                            </tr>
            ...
            <div class="mt-8 grid grid-cols-2 gap-x-12 text-[13px] text-black">
                <div>
                    ...
                    <div class="border-b border-black w-48 mb-1 pb-1">
                        <input type="text" id="pdfPrepBy" class="font-bold bg-transparent border-none outline-none w-full p-0" value="Reynaldo Lapiña Jr.">
                    </div>
                ...
                <div>
                    ...
                    <div class="border-b border-black w-48 mb-1 pb-1">
                        <input type="text" id="pdfCheckBy" class="font-bold bg-transparent border-none outline-none w-full p-0" value="Jacob N. Lomotos">
                    </div>
                ...
                <div class="mt-8">
                    ...
                    <div class="border-b border-black w-48 mb-1 pb-1">
                        <input type="text" id="pdfConf1" class="font-bold bg-transparent border-none outline-none w-full p-0" placeholder="">
                    </div>
                    <p class="text-xs">Debtor/Creditor</p>
                </div>
                <div class="mt-8 self-end">
                    <div class="border-b border-black w-48 mb-1 pb-1">
                        <input type="text" id="pdfConf2" class="font-bold bg-transparent border-none outline-none w-full p-0" placeholder="">
                    </div>
                    <p class="text-xs">Debtor/Creditor</p>
                </div>
            </div>
...
function exportData(format) {
    ...
    if (format === 'excel') {
        ...
        const rows = [
            [{ v: "Account Name :", s: labelStyle }, { v: accountName, s: borderStyle }, { v: "", s: borderStyle }, { v: "", s: borderStyle }, { v: "", s: borderStyle }, { v: "", s: borderStyle }, { v: "", s: borderStyle }],
            [{ v: "Contact Number", s: labelStyle }, { v: "9514791978", s: borderStyle }, { v: "", s: borderStyle }, { v: "", s: borderStyle }, { v: "", s: borderStyle }, { v: "", s: borderStyle }, { v: "", s: borderStyle }],
            [{ v: "PN Number :", s: labelStyle }, { v: pnNumber, s: borderStyle }, { v: "", s: borderStyle }, { v: "Loan Amount :", s: labelStyle }, { v: 224276.00, s: { font: { bold: true }, ...borderStyle }, t: 'n', z: '#,##0.00' }, { v: "", s: borderStyle }, { v: "", s: borderStyle }],
            [{ v: "PN Date :", s: labelStyle }, { v: "February 3, 2024", s: { alignment: { horizontal: "center" }, ...borderStyle } }, { v: "", s: borderStyle }, { v: "Term :", s: labelStyle }, { v: 10, s: { alignment: { horizontal: "right" }, font: { bold: true }, ...borderStyle } }, { v: "months", s: borderStyle }, { v: "", s: borderStyle }],
            [{ v: "PN Maturity :", s: labelStyle }, { v: "December 3, 2024", s: { alignment: { horizontal: "center" }, ...borderStyle } }, { v: "", s: borderStyle }, { v: "Interest Rate (AOR)", s: labelStyle }, { v: "96 %", s: { alignment: { horizontal: "right" }, font: { bold: true }, ...borderStyle } }, { v: "", s: borderStyle }, { v: "", s: borderStyle }],
            // FIXED: Added the Monthly Amortization value (monthlyAmt) to the correct cell
            [{ v: "", s: borderStyle }, { v: "", s: borderStyle }, { v: "", s: borderStyle }, { v: "Monthly Amortization", s: labelStyle }, { v: "", s: borderStyle }, { v: parseFloat(monthlyAmt.replace(/,/g, '')), s: { font: { bold: true }, alignment: { horizontal: "right" }, ...borderStyle }, t: 'n', z: '#,##0.00' }, { v: "", s: borderStyle }],
            [{v: "", s: {border: {left: {style: "thin"}}}}, "", "", "", "", "", {v: "", s: {border: {right: {style: "thin"}}}}],
            [{ v: "APPLICATION", s: headerStyle }, {v: "", s: borderStyle}, {v: "", s: borderStyle}, {v: "", s: borderStyle}, {v: "", s: borderStyle}, {v: "", s: borderStyle}, {v: "", s: borderStyle}],
            [{ v: "#", s: headerStyle }, { v: "DATE", s: headerStyle }, { v: "PRINCIPAL", s: headerStyle }, { v: "INTEREST", s: headerStyle }, { v: "TOTAL AMOUNT", s: headerStyle }, { v: "PRINCIPAL BALANCE", s: headerStyle }, { v: "STATUS", s: headerStyle }],
            [{ v: "", s: borderStyle }, { v: "", s: borderStyle }, { v: "", s: borderStyle }, { v: "", s: borderStyle }, { v: "", s: borderStyle }, { v: 224276.00, s: { font: { bold: true }, ...borderStyle }, t: 'n', z: '#,##0.00' }, { v: "", s: borderStyle }]
        ];
        ...
        tbodyRows.forEach((tr, index) => {
            ...
            if(cols.length >= 6) {
                rows.push([
                    ...
                    { v: parseFloat(cols[2].innerText.replace(/,/g, '')), s: borderStyle, t: 'n', z: '#,##0.00' },
                    { v: parseFloat(cols[3].innerText.replace(/,/g, '')), s: borderStyle, t: 'n', z: '#,##0.00' }, 
                    { v: parseFloat(cols[4].innerText.replace(/,/g, '')), s: borderStyle, t: 'n', z: '#,##0.00' }, 
                    { v: parseFloat(cols[5].innerText.replace(/,/g, '')), s: borderStyle, t: 'n', z: '#,##0.00' },
                    { v: cols[6] ? cols[6].innerText : "", s: borderStyle }
                ]);
            }
        });
        ...
        rows.push([], []); 
        rows.push([{ v: preparedByValue.toUpperCase(), s: boldStyle }, "", "", { v: checkedByValue.toUpperCase(), s: boldStyle }]);
        rows.push([{ v: "LOANS EVALUATOR", s: { font: { size: 9 } } }, "", "", { v: "ML Lending Head", s: { font: { size: 9 } } }]);
        rows.push([], []); 
        rows.push([{ v: "Conforme:", s: boldStyle }]);
        rows.push([], []); 
        rows.push([{ v: conforme1Value.toUpperCase(), s: underlineStyle }, "", "", { v: conforme2Value.toUpperCase(), s: underlineStyle }]);
        ...
        ws['!merges'] = [
            ...
            { s: { r: 1, c: 1 }, e: { r: 1, c: 6 } }, 
            { s: { r: 7, c: 0 }, e: { r: 7, c: 6 } }, 
            { s: { r: 5, c: 3 }, e: { r: 5, c: 4 } } // Merged the label "Monthly Amortization"
        ];
        
        ws['!cols'] = [{ wch: 8 }, { wch: 15 }, { wch: 15 }, { wch: 15 }, { wch: 15 }, { wch: 20 }, { wch: 12 }];

        XLSX.utils.book_append_sheet(wb, ws, "Amortization");
        XLSX.writeFile(wb, `Amortization_${pnNumber}.xlsx`);

    } else if (format === 'pdf') {
        // ... (PDF logic remains the same as previous working version)
        const { jsPDF } = window.jspdf;
        const doc = new jsPDF('p', 'mm', 'a4');
        const img = document.getElementById('mlLogo');
        if (img) doc.addImage(img.src, 'PNG', 85, 10, 40, 8);
        
        doc.setFontSize(14);
        doc.text("Monthly Amortization", 105, 25, { align: "center" });
        ...
        doc.autoTable({
            ...
            body: [
                ['Account Name:', accountName, 'PN Number:', pnNumber],
                ['Contact:', document.getElementById('modalDispContact')?.innerText || "", 'Loan Amount:', document.getElementById('modalDispLoanAmt').innerText],
                ['PN Date:', document.getElementById('modalDispPnDate').innerText, 'Term:', document.getElementById('modalDispTerm').innerText],
                ['PN Maturity:', document.getElementById('modalDispMaturity').innerText, 'Interest Rate:', document.getElementById('modalDispAOR').innerText],
                ['', '', 'Monthly Amortization:', document.getElementById('modalDispMonthly').innerText]
            ],
        ...
        doc.text(preparedByValue, 20, finalY + 10);
        doc.setFont(undefined, 'normal');
        doc.line(20, finalY + 11, 70, finalY + 11);
        doc.text("LOANS EVALUATOR", 20, finalY + 15);
        doc.text("Checked by:", 120, finalY);
        doc.setFont(undefined, 'bold');
        doc.text(checkedByValue, 120, finalY + 10);
        doc.setFont(undefined, 'normal');
        doc.line(120, finalY + 11, 170, finalY + 11);
        doc.text("ML Lending Head", 120, finalY + 15);
        doc.text("Conforme:", 20, finalY + 30);
        doc.setFont(undefined, 'bold');
        doc.text(conforme1Value, 20, finalY + 40);
        doc.text(conforme2Value, 120, finalY + 40);
        doc.setFont(undefined, 'normal');
        doc.line(20, finalY + 41, 70, finalY + 41);
        doc.text("Debtor/Creditor", 20, finalY + 45);
        doc.line(120, finalY + 41, 170, finalY + 41);
        doc.text("Debtor/Creditor", 120, finalY + 45);
